...
"")
        ...
        self.timeRemaining = QtWidgets.QLabel(self.operateTab)
        self.timeRemaining.setGeometry(QtCore.QRect(230, 90, 211, 21))
        font = QtGui.QFont()
        font.setFamily("Gotham Medium")
        font.setPointSize(14)
        self.timeRemaining.setFont(font)
        self.timeRemaining.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.timeRemaining.setStyleSheet("color: rgb(255, 255, 255);\n"
"background-color: rgba(255, 255, 255, 0);")
        self.timeRemaining.setScaledContents(True)
...
"background-color: rgba(255, 255, 255, 0);")
        ...
        self.FileNameLabel_2 = QtWidgets.QLabel(self.operateTab)
        self.FileNameLabel_2.setGeometry(QtCore.QRect(60, 120, 161, 21))
        font = QtGui.QFont()
        font.setFamily("Gotham Light")
        font.setPointSize(14)
        font.setBold(False)
        ...
        self.FileNameLabel_2.setContextMenuPolicy(QtCore.Qt.NoContextMenu)
        self.FileNameLabel_2.setStyleSheet("color: rgb(255, 255, 255);")
...
"")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(".\\templates/img/settings.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap(".\\templates/img/settings_white.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.timeRemaining.setText(_translate("MainWindow", "00H 00M"))
        self.materialPreset.setText(_translate("MainWindow", "None"))
        self.FileNameLabel_2.setText(_translate("MainWindow", "Material Preset:"))
